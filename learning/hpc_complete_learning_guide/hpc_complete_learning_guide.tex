...
\begin{verbatim}
[Data]   Users: 1000 | Items: 1000 | Sparsity: 70% | Test: 29874
[Timing] Similarity matrix  : 12.3456 s
[Timing] Prediction phase   : 8.7654 s
[Timing] Total (sim+pred)   : 21.1110 s
[Check]  Sim-matrix checksum: 499876.543210
[Eval]   MAE on test set    : 0.4523
\end{verbatim}
...
I/O).  For our project, $f \approx 2$--$5\%$, giving $S_{\max} \approx
20$--$50\times$.
...
\vspace{1em}
\begin{center}
\textbf{Expected Speedup Order} (approximate, 8 workers or equivalent)\\[0.5em]
\texttt{CUDA} $>$ \texttt{Hybrid} $\geq$ \texttt{MPI} $\approx$ \texttt{OpenMP}
$>$ \texttt{Pthreads} $>$ \texttt{Serial}
\end{center}
